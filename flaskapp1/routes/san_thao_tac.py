...
def get_float(req, name):
    try:
        return float(req.form.get(name, 0))
    except:
        return 0
...
def san_thao_tac():
    ...
    if request.method == "POST":
        ...
        A2 = get_float(request, "chieu_dai")
        B2 = get_float(request, "chieu_rong")
        C2 = get_float(request, "chieu_cao")
        D2 = get_float(request, "do_day_ton")
        E2 = get_float(request, "so_chan")

        F11 = get_float(request, "thanh_ngang")
        G11 = get_float(request, "thanh_doc")
