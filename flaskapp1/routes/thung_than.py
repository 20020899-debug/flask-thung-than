L_tong = get_float("Chiều dài tổng")
            ...
            kl_2_dau = (((Rong+Dau_vao)/2*math.sqrt(((Rong-Dau_vao)/2)**2+((L_tong-L_thung)/2)**2)+(Cao+Dau_vao)/2*math.sqrt(((Cao-Dau_vao)/2)**2+((L_tong-L_thung)/2)**2))*4+Rong*Cao)*Day*THEP/MM3

            kl_chan = U100/1000*9.35 + U150/1000*19

            kl_san = (80 * 3 * (L_thung * Rong / 500 + Rong * L_thung / 500) * so_tang * THEP
                / MM3)+ L_thung * Rong * 11 * so_tang / 1_000_000
            ...
            kl_loc = (
                (149*Cao*Day + 128*Rong*Day*2 + 108*Rong*Day*2 + 54*Cao*Day*4)
                * THEP / MM3
                * so_tam_loc
            )
